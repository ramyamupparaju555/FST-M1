...
public class Activity2 {
    ...
    public void getUserInfo() {
        ...
        response.then().body("username", equalTo("Ramya"));
        response.then().body("firstName", equalTo("Ramya"));
        response.then().body("lastName", equalTo("Mupparaju"));
        response.then().body("email", equalTo("jramyamupparaju@mail.com"));
        response.then().body("password", equalTo("password555"));
        response.then().body("phone", equalTo("9010112349"));
    }
